package com.demo.onlinestore.domain;
...
public class Invoice implements Serializable {
    ...
    private ProductOrder invoiceId;
    ...
    public ProductOrder getInvoiceId() {
        return invoiceId;
    }

    public Invoice invoiceId(ProductOrder productOrder) {
        this.invoiceId = productOrder;
        return this;
    }

    public void setInvoiceId(ProductOrder productOrder) {
        this.invoiceId = productOrder;
    }
